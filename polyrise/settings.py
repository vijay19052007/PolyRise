"""
Django settings for polyrise project.
...
SECRET_KEY = 'django-insecure-l%ns=0e+fi*h@+*vo%xfy(ac4-uako$*kn0=6-p+zy+!d(tdz5'
...
WSGI_APPLICATION = 'polyrise.wsgi.application'
